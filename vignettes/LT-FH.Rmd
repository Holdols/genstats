...
In the above table we see the result of the association analysis, where we can se which SNP's is estimated as casual. We are using bonferronni correction to lower the amount of false positive causal SNP. And since we have $1e^3$ indiviuals we will use $p=\frac{0.05}{1000}=5e^{-5}$. We can se the result of our
