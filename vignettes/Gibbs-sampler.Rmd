...
\right)
$$
Using the multivariate normal the conditional distribution for each variable can easily be calculated. To illustrate that the simulated data has this distrubution we will calculate the covariance matrix of non truncated data using a heriability of 0.5 and one sibling.
