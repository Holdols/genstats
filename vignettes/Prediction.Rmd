...
```{r eval=FALSE}
decision_cross(train_set, y_ltfh, cross_folds = 4, bounds=seq(0.2, 0.3, 0.01), thr = 3)
```
...
```{r, echo = FALSE}
knitr::include_graphics("prs_true_train_01lin.jpg")
knitr::include_graphics("prs_true_test_01lin.jpg")
```
