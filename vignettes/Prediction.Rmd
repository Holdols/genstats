...
Using the same method as above we can see that the correlation between the genetic liability and PRS found with linear regression using phenotypes is much lower.



```{r, echo = FALSE, fig.show='hold',fig.align='center', fig.cap = "LT-FH vs GWAS"}
