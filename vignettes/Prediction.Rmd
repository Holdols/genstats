...
We will in this section explain the process behind the above result
...
# PRS
```{r, echo = FALSE}
knitr::include_graphics("ltfh_tr_est_prs.jpg")
```

```{r, echo = FALSE}
knitr::include_graphics("ltfh_tr_est_model.jpg")
```


```{r, echo = FALSE}
knitr::include_graphics("ltfh_tr_true_prs.jpg")
```

```{r, echo = FALSE}
knitr::include_graphics("ltfh_tr_true_model.jpg")
```
...
```{r, echo = FALSE}
knitr::include_graphics("ltfh_te_true_prs.jpg")
```
```{r, echo = FALSE}
knitr::include_graphics("ltfh_te_true_model.jpg")
```
