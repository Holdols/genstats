...
```{r}
gwas_summary <- GWAS(G = data$genotypes, y = data$fam$pheno_0, p = 0.05/100000, ncores = 6)
gwaslog_summary <- GWAS(G = data$genotypes, y = data$fam$pheno_0, logreg = TRUE, p = 0.05/100000, ncores = 6)
gwas_LTFH <- GWAS(G = data$genotypes, y = data_ltfh$l_g_est_0, p = 0.05/100000, ncores = 6)
```
```{r}
library(tidyverse)
