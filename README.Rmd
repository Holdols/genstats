...
and LT-FH. Moreover have we provided a method which can be used to predict, 
based on the subjects genotypes.
Furthermore the structure of simulated data is easy to use in
...
that the columns match the following standard.
